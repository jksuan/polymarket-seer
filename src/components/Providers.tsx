...
import { resolvePrivyWalletList } from "@/lib/privyWalletList";
...
export default function Providers({ children }: { children: React.ReactNode }) {
  ...
  const [walletList, setWalletList] = useState<ReturnType<typeof resolvePrivyWalletList> | null>(null);

  useEffect(() => {
    setWalletList(resolvePrivyWalletList());
  }, []);
