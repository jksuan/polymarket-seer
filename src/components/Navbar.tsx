import { LogOut, RefreshCw, Copy, Check, Globe } from "lucide-react";
...
export default function Navbar({
  ...
  const LangToggle = () => (
    <button
      ...
      className="flex items-center gap-1.5 h-9 px-3 rounded-full bg-zinc-900/90 backdrop-blur-md border border-zinc-800 shadow-xl hover:border-zinc-600 active:scale-95 transition-all shrink-0"
    >
