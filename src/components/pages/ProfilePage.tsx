          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex items-center gap-1.5 bg-[#192540] px-2.5 py-1 rounded-full border border-white/10">
              ...
              <div className="text-[20px] font-bold text-[#dee5ff] tracking-tight leading-tight px-1">
                湖人{" "}
                <span className="font-medium text-[#a3aac4]">
                  vs 勇士
                </span>
              </div>
              ...
              <div className="flex items-center mt-5 px-1">
                <div className="flex-1">
                  <div className="text-[11px] font-bold text-[#a3aac4] uppercase tracking-[1px] whitespace-nowrap">
                    已成交
                  </div>
                  <div className="mt-1 text-[16px] sm:text-[18px] font-bold text-[#6bff8f]">
                    $20.00
                  </div>
                </div>
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-1 text-[16px] sm:text-[18px] font-bold text-[#dee5ff]">
                    $50.00
                  </div>
                </div>
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-1 text-[16px] sm:text-[18px] font-bold text-[#a3aac4] whitespace-nowrap">
                    2小时后
                  </div>
                </div>
