  ...
  return (
    ...
    >
      {portfolioLoading && (!openOrders || openOrders.length === 0) ? (
        ...
        <ProfileEmptyState loading={false} emptyText={t.profile.orderEmpty} />
      ) : (
            ...
            >
              <div className="flex items-center gap-3 px-0.5">
                ...
                <div className="flex flex-col items-start min-w-0 flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-0.5">
                    <span className="text-[11px] font-medium text-[#a3aac4]">
                      {isBuy ? t.profile.orderBuy : t.profile.orderSell}
                    </span>
                ...
                <div className="flex items-center gap-1.5 bg-[#192540] px-2 py-1 rounded-full border border-white/10 shrink-0 self-start">
                  ...
                  <span className="text-[10px] font-bold text-[#60a5fa] tracking-wider uppercase">{t.profile.orderQueued}</span>
                </div>
              </div>
